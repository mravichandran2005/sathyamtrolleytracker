...
export default function DispatchModal({ direction, trolleyTypes, companies, vehicles, fixedCompanyId, userId, onClose, onCreated }) {
  ...
  async function submit(e) {
    ...
    try {
      ...
      // Fire-and-forget: notify whoever needs to confirm this. Never blocks
      // or fails the actual dispatch if it doesn't go through.
      supabase.functions.invoke('notify-pending', { body: { transactionId: tx.id } }).catch(() => {})
