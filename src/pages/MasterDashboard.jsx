...
export default function MasterDashboard() {
  ...
  return (
    <div>
      ...
      {tab === 'Month close' && <CloseMonth companies={companies} trolleyTypes={trolleyTypes} />}
  ...
  return (
    <div className="manifest">
      {profiles.map((p) => {
        ...
        const role = edit.role ?? p.role
        return (
          <div key={p.id} className="manifest-row" style={{ flexDirection: 'column', alignItems: 'stretch', opacity: p.active ? 1 : 0.55 }}>
            <div className="row-between">
              <div>
